        ...
        <nav className="flex-1 flex flex-col gap-1 px-3">
          <Link
            ...
            className={`flex items-center gap-3.5 px-3 py-3 rounded-xl transition-all duration-150 font-medium text-[15px] ${
              isFeed ? "bg-[#FF5500]/10 text-[#FF5500]" : "text-[#8C7B6E] hover:bg-[#EDE3D8] hover:text-[#1A1208]"
            }`}
          ...
          <Link
            href="/discover"
            className={`flex items-center gap-3.5 px-3 py-3 rounded-xl transition-all duration-150 font-medium text-[15px] ${
              isDiscover ? "bg-[#FF5500]/10 text-[#FF5500]" : "text-[#8C7B6E] hover:bg-[#EDE3D8] hover:text-[#1A1208]"
            }`}
          ...
          <Link
            ...
            className={`flex items-center gap-3.5 px-3 py-3 rounded-xl transition-all duration-150 font-medium text-[15px] ${
              isProfile ? "bg-[#FF5500]/10 text-[#FF5500]" : "text-[#8C7B6E] hover:bg-[#EDE3D8] hover:text-[#1A1208]"
            }`}
