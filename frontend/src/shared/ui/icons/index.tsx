...
export function SearchIcon({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#C4B5A5" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round">
...
export function ImageIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#C4B5A5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function AlertIcon({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#C4B5A5" strokeWidth="1.5" strokeLinecap="round">
